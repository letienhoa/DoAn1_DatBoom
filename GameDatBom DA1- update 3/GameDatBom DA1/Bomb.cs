                ...
                for (int i = 0; i < 3; i++)
                {
                    if (taogiaodien.mangluu[y][x + i].Tag != "khongphaduoc" && dem < 1)
                    {
                        if (LoaiMap.map1[y, x + i] == 3)
                        {
                            ...
                            if(taogiaodien.DSExits.Count==1&& y==taogiaodien.DSExits[0].Y&&taogiaodien.DSExits[0].X==x+i)
                            {
                                taogiaodien.mangluu[y][x + i].BackgroundImage = Properties.Resources.loithoat;
                                taogiaodien.mangluu[y ][x+i].Tag = "loithoat";
                                LoaiMap.map1[y, x + i] = 0;
                            }
                            for (int m = 0; m < taogiaodien.DSExits.Count; m++)
                            {
                                if (taogiaodien.DSExits[m].Y == y && taogiaodien.DSExits[m].X == x + i)
                                    taogiaodien.DSExits.Remove(taogiaodien.DSExits[m]);
                            }
                            dem++;
                        }
                        else
                ...
                for (int i = 1; i < 3; i++)
                {
                    ...
                    if (taogiaodien.mangluu[y][x - i].Tag != "khongphaduoc" && dem < 1)
                    {
                        if (LoaiMap.map1[y, x - i] == 3)
                        {
                            ...
                            if (taogiaodien.DSExits.Count==1 && taogiaodien.DSExits[0].Y==y && taogiaodien.DSExits[0].X== x - i)
                            {
                                taogiaodien.mangluu[y][x -i].BackgroundImage = Properties.Resources.loithoat;
                                taogiaodien.mangluu[y ][x-i].Tag = "loithoat";
                                LoaiMap.map1[y, x - i] = 0;
                ...
                for (int i = 1; i < 3; i++)
                {
                    ...
                    if (taogiaodien.mangluu[y - i][x].Tag != "khongphaduoc" && dem < 1)
                    {
                        if (LoaiMap.map1[y - i, x] == 3)
                        {
                            ...
                            if (taogiaodien.DSExits.Count == 1 && taogiaodien.DSExits[0].Y== y - i && taogiaodien.DSExits[0].X== x)
                            {
                            ...
                            for (int m = 0; m < taogiaodien.DSExits.Count; m++)
                            {
                                if (taogiaodien.DSExits[m].Y == y-i && taogiaodien.DSExits[m].X == x)
                                    taogiaodien.DSExits.Remove(taogiaodien.DSExits[m]);
                            }
                            dem++;
                        }
